package br.com.ifpe.oxefood_api_jessica.config; // Ajuste o package!
...
public class SecurityConfiguration {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {//secfiterchain: filtração de acesso em rotas
